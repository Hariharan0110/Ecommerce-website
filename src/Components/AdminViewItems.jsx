...
export default function AdminViewItems(){
    ...
    function editPage(id){
        navigate(`/adminhome/updateproducts/${id}`)
    }
                    ...
                    <div className="sub_items">
                        <div className="card1">
                            ...
                            <div className="descriptions">
                                ...
                                <button type = "button"  onClick={()=> {deleteProducts(product.id,product.productname)}} className = 'btn btn-danger'><DeleteForeverIcon />Delete</button>
                            </div>
                        </div>
                    </div>
                )
